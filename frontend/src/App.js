...
function App() {
  ...
  const createRule = async () => {
    try {
      ...
      const response = await axios.post('http://localhost:3000/create_rule', { rule });
  ...
  const combineRules = async () => {
    try {
      ...
      const response = await axios.post('http://localhost:3000/combine_rules', { rules });
  ...
  const evaluateRule = async () => {
    try {
      ...
      const response = await axios.post('http://localhost:3000/evaluate_rule', { ast: combinedAst, data: JSON.parse(data) });
